...
import com.webank.weid.blockchain.service.fisco.engine.WeIdServiceEngineFisco;
 ...
 */
public class WeIdServiceFiscoEngineFiscoV2 extends BaseEngineFisco implements WeIdServiceEngineFisco {

    private static final Logger logger = LoggerFactory.getLogger(WeIdServiceFiscoEngineFiscoV2.class);
     ...
     * 构造函数.
     */
    public WeIdServiceFiscoEngineFiscoV2() {
    ...
    /* (non-Javadoc)
     * @see com.webank.weid.blockchain.service.fisco.engine.WeIdController#isWeIdExist(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.webank.weid.blockchain.service.fisco.engine.WeIdController#isDeactivated(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.webank.weid.blockchain.service.fisco.engine.WeIdController#getWeIdDocument(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.webank.weid.blockchain.service.fisco.engine.WeIdController
