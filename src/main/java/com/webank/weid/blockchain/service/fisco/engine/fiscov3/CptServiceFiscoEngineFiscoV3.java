 ...
 */
public class CptServiceFiscoEngineFiscoV3 extends BaseEngineFisco implements CptServiceEngineFisco {

    private static final Logger logger = LoggerFactory.getLogger(
        CptServiceFiscoEngineFiscoV3.class);
     ...
     * 构造函数.
     */
    public CptServiceFiscoEngineFiscoV3() {
    ...
    public ResponseData<Integer> putPolicyIntoPresentation(List<Integer> policyIdList,
        ...
        CptController cptController =
            reloadContract(fiscoConfig.getCptAddress(), weIdPrivateKey,
                CptController.class);
