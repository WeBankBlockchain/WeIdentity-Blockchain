...
public interface DataBucketServiceEngine {
     ...
     * @return 返回是否存放成功
     */
    ResponseData<Boolean> put(String bucketId, String key, String value, String privateKey);
     ...
     * @return 返回是否移除成功
     */
    ResponseData<Boolean> removeExtraItem(String bucketId, String key, String privateKey);
     ...
     * @return 返回是否启用成功
     */
    ResponseData<Boolean> enable(String bucketId, String privateKey);
     ...
     * @return 返回是否停用成功
     */
    ResponseData<Boolean> disable(String bucketId, String privateKey);
