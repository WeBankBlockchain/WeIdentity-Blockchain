...
public class DataBucketServiceFiscoEngineV3 extends BaseEngineFisco implements DataBucketServiceEngine {

    private static final Logger logger = LoggerFactory.getLogger(
        DataBucketServiceFiscoEngineV3.class);
     ...
     */
    public DataBucketServiceFiscoEngineV3(CnsType cnsType) {
