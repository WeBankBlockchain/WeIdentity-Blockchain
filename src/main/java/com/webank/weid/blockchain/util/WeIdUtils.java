...
import com.webank.weid.blockchain.protocol.response.CreateWeIdDataResult;
...
public final class WeIdUtils {
    ...
    private static String getChainId() {
        return BaseServiceFisco.getChainId();
    }
    ...
    public static CreateWeIdDataResult createWeId() {
        ...
        BigInteger publicKeyInt = DataToolUtils.publicKeyFromPrivate(new BigInteger(privateKey, 10));
        WeIdPublicKey userWeIdPublicKey = new WeIdPublicKey();
        userWeIdPublicKey.setPublicKey(publicKeyInt.toString(10));
        ...
        //替换国密
        String weId = WeIdUtils.convertPublicKeyToWeId(publicKeyInt.toString(10));
        result.setWeId(weId);
        return result;
    }
