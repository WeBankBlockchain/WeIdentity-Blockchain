package com.webank.weid.blockchain.util.Multibase;
...
public class Multibase {
    ...
    public static String encode(Base b, byte[] data) {
        switch (b) {
            ...
            case Base64:
                return b.prefix + com.webank.weid.blockchain.util.Multibase.Base64.encodeBase64String(data).replaceAll("=", "");
            case Base64Url:
                return b.prefix + com.webank.weid.blockchain.util.Multibase.Base64.encodeBase64URLSafeString(data).replaceAll("=", "");
            case Base64Pad:
                return b.prefix + com.webank.weid.blockchain.util.Multibase.Base64.encodeBase64String(data);
            case Base64UrlPad:
                return b.prefix + com.webank.weid.blockchain.util.Multibase.Base64.encodeBase64String(data).replaceAll("\\+", "-").replaceAll("/", "_");
            default:
